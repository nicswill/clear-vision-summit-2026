...
import { ArrowLeft, Users, Mic, Target } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Whether you're here to share your expertise, guide others, or
              transform your own leadership journey, we have the perfect
          ...
          <div className="text-center mt-16">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-3xl mx-auto">
              ...
              <p className="text-gray-600 mb-6">
                ...
                here to help you choose the perfect path for your summit
                experience.
              </p>
